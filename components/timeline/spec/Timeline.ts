...
describe('Timeline', () => {
  describe('when given all props', () => {
    ...
    let itemString = items[0].action + " by " + items[0].by + items[0].date.toLocaleString('en-GB', { timeZone: 'UTC' }) + items[0].description +
  ...
  describe('when given mandatory props', () => {
    ...
    let itemString = items[0].action + items[0].date.toLocaleString('en-GB', { timeZone: 'UTC' }) + items[0].description +
    ...
    it('should show the date', () => {
      expect(timeline.text()).toContain(items[1].date.toLocaleString('en-GB', { timeZone: 'UTC' }));
    });
  ...
  describe('when given no props', () => {
    ...
    it('should not show the title', () => {
      expect(timeline.text()).not.toContain(items[0].action);
    });
    ...
    it('should not show the date', () => {
      expect(timeline.text()).not.toContain(items[1].date.toLocaleString('en-GB', { timeZone: 'UTC' }));
    });

    it('should not show the description', () => {
      expect(timeline.text()).not.toContain(items[0].description);
    });
  })
});
