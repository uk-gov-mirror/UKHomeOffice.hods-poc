  ...
  <Story name="Timeline">
    <Timeline items={[
      ...
      },
      {
        ...
        description: (<p>This is a description of the event. <strong>This field uses React code to format text</strong></p>)
      }]}
    />
  </Story>
</Preview>
  ...
  <Story name="Standard">
    <Timeline items={[
      ...
      },
      {
        ...
        description: (<p>This is a description of the event. <b>This field uses React code to format text</b></p>)
      }]}
    />
  </Story>
</Preview>
